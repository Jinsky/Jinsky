<!-- Footer -->
<footer class="bg-slate-100 dark:bg-slate-950 w-full pt-16 pb-8 mt-auto">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-12 max-w-7xl mx-auto px-8 border-t border-slate-200/50 dark:border-slate-800/50 pt-16">
        <div class="col-span-1 md:col-span-1">
            <div class="text-xl font-headline font-bold text-cyan-900 dark:text-cyan-100 mb-4">Clinical Vitality</div>
        ...
        <div>
            <h5 class="text-cyan-900 dark:text-cyan-100 font-bold mb-6">Navigasi</h5>
            <ul class="space-y-4">
                <li><a class="text-slate-500 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-200 transition-colors" href="index.php">Beranda</a></li>
                <li><a class="text-slate-500 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-200 transition-colors" href="konsultasi.php">Konsultasi</a></li>
                <li><a class="text-slate-500 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-cyan-200 transition-colors" href="katalog.php">Katalog Penyakit</a></li>
            </ul>
        </div>
        <div>
