                    ...
                    <div class="bg-surface-container-lowest rounded-xl p-6 flex flex-col lg:flex-row lg:items-center gap-6 transition-all hover:bg-surface-container-low/50 relative overflow-hidden">
                        ...
                        <div class="lg:w-64">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <?php
                                    $match_count = round(($r['confidence'] / 100) * 3);
                                    $label = getMatchLevel($match_count);
                                ?>
                                <span class="bg-<?= $r['id_penyakit'] ? 'error' : 'secondary' ?>-container text-on-<?= $r['id_penyakit'] ? 'error' : 'secondary' ?>-container text-[10px] font-bold px-2 py-0.5 rounded-full">Kecocokan <?= $label ?></span>
                            </div>
                        </div>
